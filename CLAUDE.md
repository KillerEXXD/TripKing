...
4. 🔶 **Admin operations** — backend done (KYC review/queue, vehicle-eligibility filters, reviews moderation, translation = `/admin/languages`); the KYC video console + KYC doc viewer shipped with phase 7 below; UIs TODO (eligibility dashboard, translation manager, moderation queue).
