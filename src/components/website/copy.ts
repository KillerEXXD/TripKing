...
export interface WebsiteCopy {
  ...
  pricing: { title: string; body: string; points: string[] };
  finalCta: {
    h: string;
    sub: string;
    ctaOpen: string;
...
const en: WebsiteCopy = {
  ...
  hero: {
    ...
    sub: 'Trip King connects verified drivers with travel agents — post a trip, the right driver applies, pick the best one, track it live. No more WhatsApp chaos.',
    ctaDriver: 'I’m a driver',
    ctaAgent: 'I’m a travel agent',
    ctaOpen: 'Open Trip King',
    microcopy: 'KYC-verified · Live tracking · Free to start',
  },
  trust: {
    items: [
      { icon: 'shield', text: 'KYC-verified drivers' },
      { icon: 'navigation', text: 'Live trip tracking' },
      { icon: 'star', text: 'Driver ratings & reviews' },
  ...
  problem: {
    ...
    agent: {
      ...
      items: [
        { icon: 'phone', text: 'You call ten drivers to fill one trip — half don’t pick up.' },
  ...
  how: {
    ...
    driverSteps: [
      ...
      { n: '3', icon: 'hand-coins', h: 'Apply to trips — see the real payout', p: 'Browse trips near you. Every one shows the breakdown up front: rate per km, minus commission, minus GST, plus your bata. No surprises.', shot: 'trip-detail', shotLabel: 'Trip payout breakdown' },
    ...
    agentSteps: [
      ...
      { n: '2', icon: 'star', h: 'Verified drivers apply', p: 'See each applicant’s rating, trips completed, vehicle make/model/year, top tags and KYC status — side by side.', shot: 'applicants', shotLabel: 'Driver applicants + ratings' },
      { n: '3', icon: 'check-circle', h: 'Pick the one you trust', p: 'One tap assigns the driver. Everyone else is auto-rejected and notified. The passenger gets a clean confirmation card — not a forwarded mess.', shot: 'assign-driver', shotLabel: 'Assign driver' },
      { n: '4', icon: 'navigation', h: 'Track it live — and keep the record', p: 'Where the car is right now, time to reach, on-time / delayed. Answer the customer instantly. Every trip is kept with route, fare, bata, driver and timestamps. The passenger rates the driver. No more disputes.', shot: 'tracking', shotLabel: 'Live tracking + ETA' },
    ],
  },
  features: {
    ...
    items: [
      { icon: 'navigation', h: 'Live tracking & ETA', p: 'The agent (and the passenger) can see where the car is, and when it’ll arrive — on-time or delayed.', wide: true, lead: true },
      ...
      { icon: 'hand-coins', h: 'Transparent payout', p: 'Rate/km − commission − GST + bata, shown before the driver applies. No “we’ll settle later”.', wide: true },
  ...
  why: {
    title: 'Why Trip King',
    rows: [
      { a: 'vs WhatsApp groups', b: 'Verified drivers come to you, already KYC-checked. Every trip is recorded — route, fare, bata, timestamps. Live tracking. No scrolling, no chaos, no “who took it?”.' },
      ...
      { a: 'vs calling around', b: 'Post once. The right drivers — in your city and others — apply with their full profile. Pick, assign, done.' },
    ],
  },
  admin: {
  ...
  pricing: {
    title: 'What it costs',
    body: 'Free to post trips. Free to post your availability. Free to manage your drivers and passengers. A small fee only when a trip is completed — no completion, no charge.',
    points: [
      'No subscription, no setup fee.',
      'Drivers never pay to apply.',
      'You only pay on a trip that actually ran.',
    ],
  },
  finalCta: {
    h: 'Start free — today.',
    sub: 'Drivers: post your availability. Agents: post a trip. It takes a minute.',
    ctaOpen: 'Open Trip King',
...
const ta: WebsiteCopy = {
  ...
  hero: {
    ...
    sub: 'Trip King சரிபார்க்கப்பட்ட டிரைவர்களையும் டிராவல் ஏஜெண்ட்களையும் இணைக்கிறது — ஒரு டிரிப் போடுங்கள், சரியான டிரைவர் விண்ணப்பிக்கிறார், சிறந்தவரைத் தேர்வு செய்யுங்கள், நேரடியாகக் கண்காணியுங்கள். வாட்ஸ்அப் குழப்பம் இனி இல்லை.',
    ctaDriver: 'நான் ஒரு டிரைவர்',
    ctaAgent: 'நான் ஒரு டிராவல் ஏஜெண்ட்',
    ctaOpen: 'Trip King திறக்க',
    microcopy: 'KYC சரிபார்ப்பு · நேரடி கண்காணிப்பு · இலவசமாகத் தொடங்குங்கள்',
  },
  trust: {
    items: [
      { icon: 'shield', text: 'சரிபார்க்கப்பட்ட டிரைவர்கள்' },
      { icon: 'navigation', text: 'நேரடி டிரிப் கண்காணிப்பு' },
      { icon: 'star', text: 'டிரைவர் ரேட்டிங் & மதிப்பீடுகள்' },
      { icon: 'languages', text: 'English · தமிழ் · हिन्दी' },
    ],
  },
  problem: {
    ...
    agent: {
      ...
      items: [
        { icon: 'phone', text: 'ஒரு டிரிப்புக்கு பத்து டிரைவர்களை அழைக்கிறீர்கள் — பாதி பேர் போனை எடுப்பதில்லை.' },
  ...
  how: {
    ...
    driverSteps: [
      ...
      { n: '3', icon: 'hand-coins', h: 'டிரிப்புக்கு விண்ணப்பியுங்கள் — உண்மையான பேஅவுட் பாருங்கள்', p: 'அருகிலுள்ள டிரிப்களைப் பாருங்கள். ஒவ்வொன்றும் முன்கூட்டியே விவரம் காட்டுகிறது: ஒரு கி.மீ. கட்டணம், கமிஷன் கழித்து, GST கழித்து, உங்கள் பத்தா கூட்டி. ஆச்சரியம் இல்லை.', shot: 'trip-detail', shotLabel: 'டிரிப் பேஅவுட் விவரம்' },
    ...
    agentSteps: [
      { n: '1', icon: 'file-plus', h: '30 விநாடியில் டிரிப் போடுங்கள்', p: 'எங்கிருந்து, எங்கே, எப்போது, கார் வகை, இருக்கைகள், AC. ஒரு கி.மீ. கட்டணம், உங்கள் கமிஷன் %, GST, பத்தா சேர்க்கவும். முடிந்தது.', shot: 'post-trip', shotLabel: 'டிரிப் போடுங்கள்' },
      { n: '2', icon: 'star', h: 'சரிபார்க்கப்பட்ட டிரைவர்கள் விண்ணப்பிக்கிறார்கள்', p: 'ஒவ்வொரு விண்ணப்பதாரரின் ரேட்டிங், முடித்த டிரிப்கள், வாகனம், டாப் டேக்ஸ், KYC நிலை — அருகருகே பாருங்கள்.', shot: 'applicants', shotLabel: 'டிரைவர் விண்ணப்பதாரர்கள் + ரேட்டிங்' },
      { n: '3', icon: 'check-circle', h: 'நீங்கள் நம்புபவரைத் தேர்வு செய்யுங்கள்', p: 'ஒரு டேப்பில் டிரைவர் ஒதுக்கப்படுகிறார். மற்றவர்கள் தானாக நிராகரிக்கப்பட்டு அறிவிக்கப்படுகிறார்கள். பயணிக்கு சுத்தமான கன்ஃபர்மேஷன் கார்டு — ஃபார்வர்ட் செய்த குழப்பம் அல்ல.', shot: 'assign-driver', shotLabel: 'டிரைவரை ஒதுக்குங்கள்' },
      { n: '4', icon: 'navigation', h: 'நேரடியாகக் கண்காணியுங்கள் — பதிவும் வைத்திருங்கள்', p: 'கார் இப்போது எங்கே, அடைய எவ்வளவு நேரம், சரியான நேரத்திலா / தாமதமா. வாடிக்கையாளருக்கு உடனே பதில். ஒவ்வொரு டிரிப்பும் வழி, கட்டணம், பத்தா, டிரைவர், நேரங்களுடன் பதிவாகிறது. பயணி டிரைவரை மதிப்பிடுகிறார். இனி தகராறு இல்லை.', shot: 'tracking', shotLabel: 'நேரடி கண்காணிப்பு + ETA' },
    ],
  },
  features: {
    ...
    items: [
      { icon: 'navigation', h: 'நேரடி கண்காணிப்பு & ETA', p: 'ஏஜெண்ட் (மற்றும் பயணி) கார் எங்கே, எப்போது வரும் என்று பார்க்கலாம் — சரியான நேரத்திலா தாமதமா.', wide: true, lead: true },
      ...
      { icon: 'hand-coins', h: 'வெளிப்படையான பேஅவுட்', p: 'கி.மீ./கட்டணம் − கமிஷன் − GST + பத்தா, டிரைவர் விண்ணப்பிப்பதற்கு முன் காட்டப்படுகிறது. “பிறகு செட்டில் செய்வோம்” இல்லை.', wide: true },
  ...
  why: {
    title: 'ஏன் Trip King',
    rows: [
      { a: 'வாட்ஸ்அப் குழுக்களை விட', b: 'சரிபார்க்கப்பட்ட டிரைவர்கள் உங்களை அணுகுகிறார்கள், ஏற்கனவே KYC சரிபார்க்கப்பட்டவர்கள். ஒவ்வொரு டிரிப்பும் பதிவாகிறது — வழி, கட்டணம், பத்தா, நேரம். நேரடி கண்காணிப்பு. ஸ்க்ரோல் இல்லை, குழப்பம் இல்லை.' },
      ...
      { a: 'அழைத்துக்கொண்டே இருப்பதை விட', b: 'ஒரு முறை போடுங்கள். சரியான டிரைவர்கள் — உங்கள் ஊரிலும் மற்ற ஊர்களிலும் — முழு ப்ரொஃபைலுடன் விண்ணப்பிக்கிறார்கள். தேர்வு, ஒதுக்கல், முடிந்தது.' },
    ],
  },
  admin: {
  ...
  pricing: {
    title: 'கட்டணம் என்ன',
    body: 'டிரிப் போடுவது இலவசம். கிடைப்பைப் பதிவது இலவசம். டிரைவர்கள் & பயணிகளை நிர்வகிப்பது இலவசம். டிரிப் முடிந்தால் மட்டுமே சிறு கட்டணம் — முடியவில்லை என்றால் கட்டணம் இல்லை.',
    points: [
      'சந்தா இல்லை, செட்அப் கட்டணம் இல்லை.',
      'டிரைவர்கள் விண்ணப்பிக்க ஒருபோதும் பணம் கட்ட மாட்டார்கள்.',
      'உண்மையில் நடந்த டிரிப்புக்கு மட்டுமே நீங்கள் பணம் கட்டுகிறீர்கள்.',
    ],
  },
  finalCta: {
    h: 'இலவசமாகத் தொடங்குங்கள் — இன்றே.',
    sub: 'டிரைவர்கள்: உங்கள் கிடைப்பைப் போடுங்கள். ஏஜெண்ட்கள்: ஒரு டிரிப் போடுங்கள். ஒரு நிமிடம்தான்.',
    ctaOpen: 'Trip King திறக்க',
...
const hi: WebsiteCopy = {
  ...
  hero: {
    ...
    sub: 'Trip King सत्यापित ड्राइवरों को ट्रैवल एजेंटों से जोड़ता है — एक ट्रिप पोस्ट करें, सही ड्राइवर आवेदन करता है, सबसे अच्छा चुनें, लाइव ट्रैक करें। अब WhatsApp की अफरा-तफरी नहीं।',
    ctaDriver: 'मैं एक ड्राइवर हूँ',
    ctaAgent: 'मैं एक ट्रैवल एजेंट हूँ',
    ctaOpen: 'Trip King खोलें',
    microcopy: 'KYC सत्यापित · लाइव ट्रैकिंग · शुरू करना मुफ़्त',
  },
  trust: {
    items: [
      { icon: 'shield', text: 'सत्यापित ड्राइवर' },
      { icon: 'navigation', text: 'लाइव ट्रिप ट्रैकिंग' },
      { icon: 'star', text: 'ड्राइवर रेटिंग और समीक्षाएँ' },
      { icon: 'languages', text: 'English · தமிழ் · हिन्दी' },
    ],
  },
  problem: {
    ...
    agent: {
      ...
      items: [
        { icon: 'phone', text: 'एक ट्रिप के लिए दस ड्राइवरों को फ़ोन करते हैं — आधे उठाते ही नहीं।' },
  ...
  how: {
    ...
    driverSteps: [
      ...
      { n: '3', icon: 'hand-coins', h: 'ट्रिप के लिए आवेदन करें — असली पेआउट देखें', p: 'पास की ट्रिप ब्राउज़ करें। हर एक पहले से ही ब्रेकडाउन दिखाती है: प्रति किमी रेट, कमीशन घटाकर, GST घटाकर, आपका बाटा जोड़कर। कोई चौंकाने वाली बात नहीं।', shot: 'trip-detail', shotLabel: 'ट्रिप पेआउट ब्रेकडाउन' },
    ...
    agentSteps: [
      ...
      { n: '2', icon: 'star', h: 'सत्यापित ड्राइवर आवेदन करते हैं', p: 'हर आवेदक की रेटिंग, पूरी की गई ट्रिप, गाड़ी का मेक/मॉडल/साल, टॉप टैग और KYC स्थिति — साथ-साथ देखें।', shot: 'applicants', shotLabel: 'ड्राइवर आवेदक + रेटिंग' },
      { n: '3', icon: 'check-circle', h: 'जिस पर भरोसा हो उसे चुनें', p: 'एक टैप में ड्राइवर असाइन। बाक़ी सब अपने आप रिजेक्ट और सूचित। यात्री को साफ़ कन्फ़र्मेशन कार्ड — फ़ॉरवर्ड किया हुआ झमेला नहीं।', shot: 'assign-driver', shotLabel: 'ड्राइवर असाइन करें' },
      { n: '4', icon: 'navigation', h: 'लाइव ट्रैक करें — और रिकॉर्ड रखें', p: 'गाड़ी अभी कहाँ है, पहुँचने में कितना समय, समय पर / देरी। ग्राहक को तुरंत जवाब। हर ट्रिप रूट, किराया, बाटा, ड्राइवर और टाइमस्टैम्प के साथ रखी जाती है। यात्री ड्राइवर को रेटिंग देता है। अब कोई विवाद नहीं।', shot: 'tracking', shotLabel: 'लाइव ट्रैकिंग + ETA' },
    ],
  },
  features: {
    ...
    items: [
      { icon: 'navigation', h: 'लाइव ट्रैकिंग और ETA', p: 'एजेंट (और यात्री) देख सकते हैं कि गाड़ी कहाँ है और कब पहुँचेगी — समय पर या देरी से।', wide: true, lead: true },
      ...
      { icon: 'hand-coins', h: 'पारदर्शी पेआउट', p: 'रेट/किमी − कमीशन − GST + बाटा, ड्राइवर के आवेदन करने से पहले दिखाया जाता है। कोई “बाद में सेटल कर लेंगे” नहीं।', wide: true },
  ...
  why: {
    ...
    rows: [
      { a: 'WhatsApp ग्रुप के मुक़ाबले', b: 'सत्यापित ड्राइवर आपके पास आते हैं, पहले से KYC-जाँचे हुए। हर ट्रिप रिकॉर्ड होती है — रूट, किराया, बाटा, टाइमस्टैम्प। लाइव ट्रैकिंग। न स्क्रॉल, न अफरा-तफरी, न “किसने ले लिया?”।' },
      ...
      { a: 'फ़ोन घुमाते रहने के मुक़ाबले', b: 'एक बार पोस्ट करें। सही ड्राइवर — आपके शहर में और दूसरों में — अपनी पूरी प्रोफ़ाइल के साथ आवेदन करते हैं। चुनें, असाइन करें, हो गया।' },
    ],
  },
  admin: {
  ...
  pricing: {
    title: 'कीमत क्या है',
    body: 'ट्रिप पोस्ट करना मुफ़्त। अपनी उपलब्धता पोस्ट करना मुफ़्त। अपने ड्राइवरों और यात्रियों को मैनेज करना मुफ़्त। ट्रिप पूरी होने पर ही एक छोटा शुल्क — पूरी नहीं हुई तो कोई शुल्क नहीं।',
    points: [
      'कोई सब्सक्रिप्शन नहीं, कोई सेटअप फ़ीस नहीं।',
      'ड्राइवर आवेदन के लिए कभी भुगतान नहीं करते।',
      'आप सिर्फ़ उस ट्रिप पर भुगतान करते हैं जो असल में चली।',
    ],
  },
  finalCta: {
    h: 'मुफ़्त शुरू करें — आज ही।',
    sub: 'ड्राइवर: अपनी उपलब्धता पोस्ट करें। एजेंट: एक ट्रिप पोस्ट करें। एक मिनट लगता है।',
    ctaOpen: 'Trip King खोलें',
