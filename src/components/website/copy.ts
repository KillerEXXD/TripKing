 ...
 *
 * No pricing/cost copy here by design — the site sells features and addresses
 * pain points only. Any "rate/km − commission − GST + bata" mentions describe
 * the in-app *trip payout breakdown* feature, not what the platform charges.
 */
