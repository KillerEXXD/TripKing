...
/**
 * /administration/designs/feedback/results — aggregation dashboard.
    ...
    <main className="mx-auto max-w-3xl space-y-5 p-6">
      ...
      {query.isLoading ? (
        ...
        <section className="rounded-card border border-dashed border-border p-8 text-center text-sm text-secondary">
          ...
          <Link to="/administration/designs/feedback" className="text-primary underline">the questionnaire</Link>.
        </section>
      ) : (
        <>
          <section>
